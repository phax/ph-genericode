 ...
 */
public class Genericode04CodeListMarshaller extends GenericJAXBMarshaller <CodeListDocument>
{
  /**
   * Constructor
   */
  ...
  {
    super (CodeListDocument.class, CGenericode.GENERICODE_04_XSDS, new ObjectFactory ()::createCodeList);
  }
}
